...
const es = {
  ...
  upd_btn: 'Actualizar',
  uz_title: 'Actualizar EasyZFS',
  uz_confirm: 'Comprueba la versión y acepta la caída del servicio para continuar.',
  uz_start: 'Instalar v{v}',
  uz_cancel: 'Cancelar',
  uz_down: 'El servicio se reiniciará y la app no estará disponible unos segundos.',
  uz_readiness_fail: 'Hay comprobaciones que no permiten actualizar (revisa la lista anterior).',
  uz_close: 'Cerrar',
  uz_restarting: 'Reiniciando EasyZFS…',
  uz_reload: 'La app se recargará cuando vuelva a estar disponible.',
  uz_failed: 'La actualización no se pudo aplicar.',
  uz_close_hint: 'La ventana se cerrará sola al recargar.',
  uz_step_downloading: 'Descargando la nueva versión',
  uz_step_installing: 'Instalando',
  uz_step_restarting: 'Reiniciando',
  ...
  np_ashift: 'Alineación (ashift)', np_ashift_hint: 'Tamaño de sector físico en log2. 12 para discos 4K (recomendado); inmutable tras crear el pool.',
  np_ashift_auto: 'Auto (0)', np_ashift_12: '12 (4K, recomendado)',
  np_ashift_13: '13 (NVMe 8K)', np_ashift_9: '9 (sectores 512B)',
  ...
  dk_identify: 'Identificar', dk_identify_hint: 'Hace parpadear el LED de actividad de la bahía para localizar el disco físicamente (lectura I/O)',
  dk_identify_started: 'Identificando {dev}: el LED de la bahía parpadea unos segundos',
  ...
  s_ch_title: 'Canales de alerta',
  s_ch_d: 'Canales de infraestructura para las alertas (independientes del push por dispositivo). Se configuran con variables de entorno en /etc/easyzfs/env y el servicio las lee al arrancar; aquí puedes comprobar que cada uno entrega de verdad.',
  s_ch_ntfy: 'ntfy',
  s_ch_gotify: 'Gotify',
  s_ch_telegram: 'Telegram',
  s_ch_syslog: 'Syslog',
  s_ch_email: 'Email (SMTP)',
  s_ch_webhook: 'Webhook saliente',
  s_ch_push: 'Push por dispositivo (Web Push)',
  s_ch_on: 'Configurado',
  s_ch_off: 'Sin configurar',
  s_ch_test: 'Probar',
  s_ch_testing: 'Enviando…',
  s_ch_ok: 'Notificación de prueba enviada',
  s_ch_edit: 'Configurar',
  s_ch_saved: 'Canal guardado',
  s_ch_disabled: 'Canal desactivado',
  s_ch_disable: 'Desactivar',
  s_ch_env_only: 'Se configura por entorno (no editable aquí)',
  s_ch_ntfy_url: 'URL del topic',
  s_ch_ntfy_url_hint: 'El topic es la contraseña: no se muestra nunca. Déjalo vacío para conservar el actual.',
  s_ch_token: 'Token',
  s_ch_token_opt: 'Token (opcional)',
  s_ch_token_hint: 'Déjalo vacío para conservar el actual.',
  s_ch_gotify_url: 'URL del servidor',
  s_ch_tg_token: 'Bot token',
  s_ch_tg_chat: 'Chat id',
  s_ch_syslog_host: 'Host',
  s_ch_syslog_port: 'Puerto',
  s_ch_syslog_proto: 'Protocolo',
  s_ch_syslog_facility: 'Facility',
  s_ch_topic_set: 'topic configurado',
  s_ch_email_host: 'Servidor SMTP',
  s_ch_email_port: 'Puerto',
  s_ch_email_user: 'Usuario',
  s_ch_email_pass: 'Contraseña',
  s_ch_email_from: 'Remitente',
  s_ch_email_enc: 'Cifrado',
  s_ch_webhook_url: 'URL del webhook',
  ...
  ab_upd_norestart: 'El mecanismo de reinicio no está configurado',
  ab_upd_norestart_d: 'El updater descargó el binario nuevo, pero easyzfs-update.path/service no están instalados. El servidor no se reiniciará solo: instálalos o reinicia el servicio manualmente tras la descarga.',
  ...
  toast_disk_identify: 'LED parpadeando: revisa la bahía',
...
const en: Record<I18nKey, string> = {
  ...
  upd_btn: 'Reload',
  uz_title: 'Update EasyZFS',
  uz_confirm: 'Check the version and acknowledge the service downtime to continue.',
  uz_start: 'Install v{v}',
  uz_cancel: 'Cancel',
  uz_down: 'The service will restart and the app will be unavailable for a few seconds.',
  uz_readiness_fail: 'There are checks that prevent updating (see the list above).',
  uz_close: 'Close',
  uz_restarting: 'Restarting EasyZFS…',
  uz_reload: 'The app will reload once it is available again.',
  uz_failed: 'The update could not be applied.',
  uz_close_hint: 'The window will close itself on reload.',
  uz_step_downloading: 'Downloading the new version',
  uz_step_installing: 'Installing',
  uz_step_restarting: 'Restarting',
  ...
  np_ashift: 'Alignment (ashift)', np_ashift_hint: 'Physical sector size as log2. 12 for 4K drives (recommended); immutable after pool creation.',
  np_ashift_auto: 'Auto (0)', np_ashift_12: '12 (4K, recommended)',
  np_ashift_13: '13 (8K NVMe)', np_ashift_9: '9 (512B sectors)',
  ...
  dk_identify: 'Identify', dk_identify_hint: 'Blink the bay activity LED to physically locate the disk (I/O read)',
  dk_identify_started: 'Identifying {dev}: the bay LED will blink for a few seconds',
  ...
  s_ch_title: 'Alert channels',
  s_ch_d: 'Infrastructure channels for alerts (independent from per-device push). They are configured with environment variables in /etc/easyzfs/env and read at startup; here you can verify each one actually delivers.',
  s_ch_ntfy: 'ntfy',
  s_ch_gotify: 'Gotify',
  s_ch_telegram: 'Telegram',
  s_ch_syslog: 'Syslog',
  s_ch_email: 'Email (SMTP)',
  s_ch_webhook: 'Outgoing webhook',
  s_ch_push: 'Per-device push (Web Push)',
  s_ch_on: 'Configured',
  s_ch_off: 'Not configured',
  s_ch_test: 'Test',
  s_ch_testing: 'Sending…',
  s_ch_ok: 'Test notification sent',
  s_ch_edit: 'Configure',
  s_ch_saved: 'Channel saved',
  s_ch_disabled: 'Channel disabled',
  s_ch_disable: 'Disable',
  s_ch_env_only: 'Configured via environment (not editable here)',
  s_ch_ntfy_url: 'Topic URL',
  s_ch_ntfy_url_hint: 'The topic is the password: it is never shown. Leave empty to keep the current one.',
  s_ch_token: 'Token',
  s_ch_token_opt: 'Token (optional)',
  s_ch_token_hint: 'Leave empty to keep the current one.',
  s_ch_gotify_url: 'Server URL',
  s_ch_tg_token: 'Bot token',
  s_ch_tg_chat: 'Chat id',
  s_ch_syslog_host: 'Host',
  s_ch_syslog_port: 'Port',
  s_ch_syslog_proto: 'Protocol',
  s_ch_syslog_facility: 'Facility',
  s_ch_topic_set: 'topic set',
  s_ch_email_host: 'SMTP server',
  s_ch_email_port: 'Port',
  s_ch_email_user: 'Username',
  s_ch_email_pass: 'Password',
  s_ch_email_from: 'Sender',
  s_ch_email_enc: 'Encryption',
  s_ch_webhook_url: 'Webhook URL',
  ...
  ab_upd_norestart: 'Restart mechanism is not configured',
  ab_upd_norestart_d: 'The updater downloaded the new binary, but easyzfs-update.path/service are not installed. The server will not restart on its own: install them or restart the service manually after the download.',
  ...
  toast_disk_identify: 'LED blinking: check the bay',
