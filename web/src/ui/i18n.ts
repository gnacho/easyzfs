...
const es = {
  ...
  uz_current: 'Actual',
  uz_latest: 'Disponible',
  uz_notes_title: 'Cambios de esta versión',
  uz_release_url: 'Ver en GitHub',
  ...
  po_title: 'Apagar disco del pool',
  po_desc: 'El disco pertenece al pool {pool}. Al apagarlo, el pool pasará a DEGRADED hasta que sustituyas el disco (zpool replace) o vuelvas a encenderlo.',
  po_confirm_lbl: 'Escribe el nombre del dispositivo para confirmar',
  ...
  dk_poweroff_pool_hint: 'Apagar el disco para sustituirlo en caliente: el pool pasará a DEGRADED',
...
const en: Record<I18nKey, string> = {
  ...
  uz_current: 'Current',
  uz_latest: 'Available',
  uz_notes_title: 'Changes in this version',
  uz_release_url: 'View on GitHub',
  ...
  po_title: 'Power off pool disk',
  po_desc: 'This disk is a member of pool {pool}. Powering it off will put the pool in DEGRADED state until you replace the disk (zpool replace) or power it back on.',
  po_confirm_lbl: 'Type the device name to confirm',
  ...
  dk_poweroff_pool_hint: 'Power the disk down for hot swap: the pool will go DEGRADED',
